...
class CreateLivraison extends StatefulWidget {
  @override
  _CreateLivraisonState createState() => _CreateLivraisonState();
}

class _CreateLivraisonState extends State<CreateLivraison> {
  AppState appState;
  String name;
  String numeroDepart;
        ...
        child: Column(
          children: <Widget>[
            Container(
                ...
                child: Text("LIVRER TOUT ET PARTOUT",
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "Qu'est-ce que vous envoyez",
